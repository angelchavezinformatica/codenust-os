...
extern uint64 sys_lamport_time(void);
extern uint64 sys_lamport_tick(void);
extern uint64 sys_lamport_recv(void);
...
[SYS_lamport_time] sys_lamport_time,
[SYS_lamport_tick] sys_lamport_tick,
[SYS_lamport_recv] sys_lamport_recv,
